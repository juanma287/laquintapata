                        ...
                        {if $voucherAllowed}
                            <form action="{if $opc}{$link->getPageLink('order-opc', true)}{else}{$link->getPageLink('order', true)}{/if}" method="post" id="voucher">
                                <fieldset>
                                    ...
                                    <button type="submit" name="submitAddDiscount" class="button btn btn-default button-small">{l s='OK'}</button>
                                </fieldset>
                            </form>
                            {if $displayVouchers}
...
<p class="cart_navigation clearfix">
    ...
    <button data-show-if-js="" style="" id="confirmOrder" type="button" class="button btn btn-default standard-checkout button-medium">{l s='Order With Obligation To Pay'}</button>
</p>
