...
<div itemscope itemtype="http://schema.org/Product">
	...
	<div class="primary_block clearfix">
		...
		<div class="pb-center-column col-xs-12 col-sm-6">
			<a onclick="javascript:history.back();" class="stupid_btn" href="#">{l s='Back'}</a>
			...
			{Module::getInstanceByName('productcomments')->hookDisplayRightColumnProduct([])}
			{/if}
					...
					<div>
						...
						{strip}
							{if $priceDisplay >= 0 && $priceDisplay <= 2}
								...
								<span id="old_price_display" {if (!$product->specificPrice || !$product->specificPrice.reduction)} class="hidden"{/if}>{if $productPriceWithoutReduction > $productPrice}{convertPrice price=$productPriceWithoutReduction|floatval}{/if}{if $tax_enabled && $display_tax_label == 1} {if $priceDisplay == 1}{l s='tax excl.'}{else}{l s='tax incl.'}{/if}{/if}</span>
							{/if}
						{/strip}
						
						{strip}
							<span id="reduction_amount_display" {if !$product->specificPrice || $product->specificPrice.reduction_type != 'amount' || $product->specificPrice.reduction|floatval ==0} style="display:none"{/if}>
			...
			<form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if} action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post">
				...
				<div class="box-info-product">
													...
													<ul id="color_to_pick_list" class="clearfix">
														...
														{foreach from=$group.attributes key=id_attribute item=group_attribute}
															...
															<li{if $group.default == $id_attribute} class="selected"{/if}>
																<a href="{$link->getProductLink($product)|escape:'html':'UTF-8'}" id="color_{$id_attribute|intval}" name="{$colors.$id_attribute.name|escape:'html':'UTF-8'}" class="color_pick{if ($group.default == $id_attribute)} selected{/if}{if ($colors.$id_attribute.value=='#ffffff')} color_pick_white{/if}"{if !$img_color_exists && isset($colors.$id_attribute.value) && $colors.$id_attribute.value} style="background:{$colors.$id_attribute.value|escape:'html':'UTF-8'};"{/if} title="{$colors.$id_attribute.name|escape:'html':'UTF-8'}">
																	{if $img_color_exists}
					...
					Module::getInstanceByName('an_staticblocks')->isEnabledBlock('advantage_productPage1') OR 
					Module::getInstanceByName('an_staticblocks')->isEnabledBlock('advantage_productPage2') OR 
					Module::getInstanceByName('an_staticblocks')->isEnabledBlock('advantage_productPage3') )
					}
						<div class="advantage_productPage_wr clearfix">
							{if Module::isEnabled('an_staticblocks') AND Module::getInstanceByName('an_staticblocks')->isEnabledBlock('advantage_productPage1')}
								<div class="advantage_productPage">
									{Module::getInstanceByName('an_staticblocks')->getBlock('advantage_productPage1', 'advantage.tpl') nofilter}
								</div>
							{/if}

							{if Module::isEnabled('an_staticblocks') AND Module::getInstanceByName('an_staticblocks')->isEnabledBlock('advantage_productPage2')}
								<div class="advantage_productPage">
									{Module::getInstanceByName('an_staticblocks')->getBlock('advantage_productPage2', 'advantage.tpl') nofilter}
								</div>
							{/if}

							{if Module::isEnabled('an_staticblocks') AND Module::getInstanceByName('an_staticblocks')->isEnabledBlock('advantage_productPage3')}
								<div class="advantage_productPage">
									{Module::getInstanceByName('an_staticblocks')->getBlock('advantage_productPage3', 'advantage.tpl') nofilter}
								</div>
							{/if}
						</div>
					{/if}
...
{else}
	<div class=" {if $display_type eq 'left_tabs' || $display_type eq 'left_vertical_tabs'} tabgroup_left{/if}{if $display_type eq 'right_tabs' || $display_type eq 'right_vertical_tabs'} tabgroup_left{/if} indent">
...
{if isset($accessories) && $accessories}
	...
	<section class="accessories">
		<h3 class="page-accessories-heading">{l s='Related products'}</h3>
								...
								<div class="product-container">
									<div class="left-block">
										<div class="product-image-container">
											...
											{hook h="displayProductPriceBlock" id_accessory=$accessory.id_accessory type="old_price"}
											{if $accessory.specific_prices.reduction_type == 'percentage'}
												<span class="percent-reduction">-{$accessory.specific_prices.reduction * 100}%</span>
											{/if}
											{if isset($accessory.new) && $accessory.new == 1}
												<a class="new-label" href="{$accessory.link|escape:'html':'UTF-8'}">{l s='New'}</a>
											{/if}

											<a class=" addToWishlist wishlistProd_{$accessory.id_accessory|intval}" href="#" rel="{$accessory.id_accessory|intval}" title="{l s='Add to Wishlist'}" onclick="WishlistCart('wishlist_block_list', 'add', '{$accessory.id_accessory|intval}', false, 1); return false;"></a>

										</div>
									</div>

									<div class="right-block">
										<a href="{$accessoryLink|escape:'html':'UTF-8'}" itemprop="name" class="product-name">
											{$accessory.name|truncate:20:'...':true|escape:'html':'UTF-8'}
										</a>
