...
<div id="new-products_block_right" class="block products_block">
    ...
    <div class="block_content products-block">
        {if $new_products !== false}
            ...
            <div>
                <a href="{$link->getPageLink('new-products')|escape:'html'}" title="{l s='All new products' mod='blocknewproducts'}" class="btn btn-default button button-small">{l s='All new products' mod='blocknewproducts'}<i class="icon-chevron-right right"></i></a>
            </div>
        {else}
