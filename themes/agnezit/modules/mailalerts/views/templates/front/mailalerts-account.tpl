...
<div id="mailalerts_block_account" class="block">
	...
	<ul class="footer_links clearfix">
		<li><a class="btn btn-default button button-small" href="{$link->getPageLink('my-account', true)|escape:'html'}" title="{l s='Back to Your Account' mod='mailalerts'}"><i class="icon-chevron-left"></i>{l s='Back to Your Account' mod='mailalerts'}</a></li>
	</ul>
</div>
