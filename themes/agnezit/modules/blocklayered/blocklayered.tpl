			...
			<div class="clearfix">
				...
				{foreach from=$filters item=filter}
					{if isset($filter.values)}
						{if isset($filter.slider)}
							<div class="layered_filter col-lg-2 col-md-3 col-sm-6 col-xs-6 layered_{$filter.type}" style="display: none;">
						{else}
