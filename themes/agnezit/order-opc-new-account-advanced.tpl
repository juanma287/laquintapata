        ...
        <fieldset>
            ...
            <div id="login_form_content" style="display:none;">
                ...
                <p class="submit">
                    ...
                    <button type="submit" id="SubmitLogin" name="SubmitLogin" data-adv-api="1" class="button btn btn-default button-medium"><i class="icon-lock left"></i>{l s='Sign in'}</button>
                </p>
            </div>
        </fieldset>
    </form>
            ...
            <div class="box">
                ...
                <div id="opc_account_choice" class="row">
                    <div class="col-xs-12 col-md-6">
                        ...
                        <p class="opc-button">
                            <button type="submit" class="btn btn-default button button-medium exclusive" id="opc_guestCheckout">{l s='Guest checkout'}</button>
                        </p>
                    </div>
                    <div class="col-xs-12 col-md-6">
                        ...
                        <p class="opc-button">
                            <button type="submit" class="btn btn-default button button-medium exclusive" id="opc_createAccount"><i class="icon-user left"></i>{l s='Create an account'}</button>
                        </p>
                    </div>
                </div>
                <div id="opc_account_form" class="unvisible">
                    ...
                    <div class="submit opc-add-save clearfix">
                        ...
                        <button type="submit" name="submitAccount" id="submitAccount" data-adv-api="1" class="btn btn-default button button-medium">{l s='Save'}<i class="icon-chevron-right right"></i></button>
