...
<form action="{$request_uri|escape:'html':'UTF-8'}" method="post" class="std" id="form_forgotpassword">
	<fieldset>
		...
		<p class="submit">
            <button type="submit" class="btn btn-default button button-medium">{l s='Retrieve Password'}<i class="icon-chevron-right right"></i></button>
		</p>
	</fieldset>
</form>
{/if}
...
<ul class="clearfix footer_links">
	<li><a class="btn btn-default button button-small" href="{$link->getPageLink('authentication')|escape:'html':'UTF-8'}" title="{l s='Back to Login'}" rel="nofollow"><i class="icon-chevron-left"></i>{l s='Back to Login'}</a></li>
</ul>
