...
function blockHoverProduct()
{
	$(document).off('mouseenter').on('mouseenter', '.accessories_slider li.ajax_block_product .product-container', function(e){
		
			$(this).parent().addClass('hovered');
		
	});

	$(document).off('mouseleave').on('mouseleave', '.accessories_slider li.ajax_block_product .product-container', function(e){
...
$(document).ready(function() {
	...
	$(".accessories_slider").each(function(){
