	...
	{else}
		<form method="post" action="{$action|escape:'html':'UTF-8'}#guestToCustomer" class="std">
			<fieldset class="description_box box">
				...
				<p>
                    <button type="submit" name="submitTransformGuestToCustomer" class="button button-medium btn btn-default">{l s='Send'}<i class="icon-chevron-right right"></i></button>
                </p>
			</fieldset>
		</form>
	{/if}
{else}
	...
	<form method="post" action="{$action|escape:'html':'UTF-8'}" class="std" id="guestTracking">
		<fieldset class="description_box box">
			...
			<p>
                <button type="submit" name="submitGuestTracking" class="button btn btn-default button-medium">{l s='Send'}<i class="icon-chevron-right right"></i></button>
            </p>
		</fieldset>
	</form>
{/if}
