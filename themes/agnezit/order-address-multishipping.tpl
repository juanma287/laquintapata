...
<div class="addresses clearfix">
	...
	{else}
		<a href="{$link->getPageLink('address', true, NULL, "back={$back_order_page}?step=1{'&multi-shipping=1'|urlencode}{if $back}&mod={$back}{/if}")|escape:'html':'UTF-8'}" title="{l s='Add'}" class="button button-small btn btn-default">{l s='Add a new address'}<i class="icon-chevron-right right"></i></a>
	{/if}
	</p>
	<div class="clearfix">
	...
	<p class="address_add submit">
		<a href="{$link->getPageLink('address', true, NULL, "back={$back_order_page}?step=1{'&multi-shipping=1'|urlencode}{if $back}&mod={$back|urlencode}{/if}")|escape:'html':'UTF-8'}" title="{l s='Add'}" class="button button-small btn btn-default">{l s='Add a new address'}<i class="icon-chevron-right right"></i></a>
	</p>
	{if !$opc}
...
{if !$opc}
			<p class="cart_navigation clearfix">
				...
				{/if}
		        <button type="submit" name="processAddress" class="button btn btn-default button-medium">{l s='Proceed to checkout'}<i class="icon-chevron-right right"></i></button>
			</p>
		</form>
{else}
	</div>
...
{capture}<a class="button button-small btn btn-default" href="{$smarty.capture.addressUrlAdd}" title="{l s='Update' js=1}">{l s='Update' js=1}<i class="icon-chevron-right right"></i></a>{/capture}
