<?php /* Smarty version Smarty-3.1.19, created on 2017-10-13 19:30:41
         compiled from "C:\xampp\htdocs\laquintapatita\themes\agnezit\product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1157259e13e916f56d8-96425594%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1157259e13e916f56d8-96425594',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59e13e919d0ae9_40364157',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59e13e919d0ae9_40364157')) {function content_59e13e919d0ae9_40364157($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'C:\\xampp\\htdocs\\laquintapatita\\tools\\smarty\\plugins\\function.math.php';
?>
...
"<?php }?> class="product_list grid clearfix<?php if (isset($_smarty_tpl->tpl_vars['class']->value)&&$_smarty_tpl->tpl_vars['class']->value) {?> <?php echo $_smarty_tpl->tpl_vars['class']->value;?>
<?php }?>">
...
%</span>
						...
						<?php if (isset($_smarty_tpl->tpl_vars['product']->value['new'])&&$_smarty_tpl->tpl_vars['product']->value['new']==1) {?>
							<a class="new-label" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
...
" itemprop="name" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" itemprop="url" >
...
<?php if (isset($_smarty_tpl->tpl_vars['id']->value)&&($_smarty_tpl->tpl_vars['id']->value=='blockbestsellers')) {?>
...
<?php }?>
<?php if (isset($_smarty_tpl->tpl_vars['id']->value)&&($_smarty_tpl->tpl_vars['id']->value=='blockspecials')) {?>
	<div class="all_products">
...
">
			<?php echo smartyTranslate(array('s'=>'Specials'),$_smarty_tpl);?>

		</a>
	</div>
<?php }?>
<?php if (isset($_smarty_tpl->tpl_vars['id']->value)&&($_smarty_tpl->tpl_vars['id']->value=='blocknewproducts')) {?>
	<div class="all_products">
