<?php /* Smarty version Smarty-3.1.19, created on 2017-10-13 19:11:15
         compiled from "C:\xampp\htdocs\laquintapatita\themes\agnezit\modules\blocklayered\blocklayered.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2549359e13a039248a2-22561535%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bcaa816ea5788c903d076bae42a51a43307b527d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\laquintapatita\\themes\\agnezit\\modules\\blocklayered\\blocklayered.tpl',
      1 => 1507755986,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2549359e13a039248a2-22561535',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59e13a03e9e1a9_27938857',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59e13a03e9e1a9_27938857')) {function content_59e13a03e9e1a9_27938857($_smarty_tpl) {?>
...
?>
					<?php if (isset($_smarty_tpl->tpl_vars['filter']->value['values'])) {?>
						<?php if (isset($_smarty_tpl->tpl_vars['filter']->value['slider'])) {?>
							<div class="layered_filter col-lg-2 col-md-3 col-sm-6 col-xs-6 layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type'];?>
" style="display: none;">
						<?php } else { ?>
							<div class="layered_filter col-lg-2 col-md-3 col-sm-6 col-xs-6">
						<?php }?>
...
?>
										...
										<li class="nomargin <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['fe']['index']>=$_smarty_tpl->tpl_vars['filter']->value['filter_show_limit']) {?>hiddable<?php }?> ">
											<?php if (isset($_smarty_tpl->tpl_vars['filter']->value['is_color_group'])&&$_smarty_tpl->tpl_vars['filter']->value['is_color_group']) {?>
												<input class="color-option<?php if (($_smarty_tpl->tpl_vars['value']->value['color']=='#ffffff')) {?> color_pick_white<?php }?> <?php if (isset($_smarty_tpl->tpl_vars['value']->value['checked'])&&$_smarty_tpl->tpl_vars['value']->value['checked']) {?>on<?php }?> <?php if (!$_smarty_tpl->tpl_vars['value']->value['nbr']) {?>disable<?php }?>" type="button" name="layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type_lite'];?>
_<?php echo $_smarty_tpl->tpl_vars['id_value']->value;?>
