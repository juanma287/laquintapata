<?php /* Smarty version Smarty-3.1.19, created on 2017-10-13 19:31:58
         compiled from "C:\xampp\htdocs\laquintapatita\themes\agnezit\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:130159e13ede00b3c5-39043348%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'df61a6b7fe85d3301adfb47b6cc6437eac19a0a5' => 
    array (
      0 => 'C:\\xampp\\htdocs\\laquintapatita\\themes\\agnezit\\product.tpl',
      1 => 1507755998,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '130159e13ede00b3c5-39043348',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59e13edee537e2_23102159',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59e13edee537e2_23102159')) {function content_59e13edee537e2_23102159($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'C:\\xampp\\htdocs\\laquintapatita\\tools\\smarty\\plugins\\function.math.php';
if (!is_callable('smarty_modifier_date_format')) include 'C:\\xampp\\htdocs\\laquintapatita\\tools\\smarty\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_function_cycle')) include 'C:\\xampp\\htdocs\\laquintapatita\\tools\\smarty\\plugins\\function.cycle.php';
if (!is_callable('smarty_function_counter')) include 'C:\\xampp\\htdocs\\laquintapatita\\tools\\smarty\\plugins\\function.counter.php';
?>
...
" data-id="resetImages">
		...
		<div class="pb-center-column col-xs-12 col-sm-6">
			<a onclick="javascript:history.back();" class="stupid_btn" href="#"><?php echo smartyTranslate(array('s'=>'Back'),$_smarty_tpl);?>
</a>
			...
			<?php echo Module::getInstanceByName('productcomments')->hookDisplayRightColumnProduct(array());?>
...
<span id="old_price_display" <?php if ((!$_smarty_tpl->tpl_vars['product']->value->specificPrice||!$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])) {?> class="hidden"<?php }?>><?php if ($_smarty_tpl->tpl_vars['productPriceWithoutReduction']->value>$_smarty_tpl->tpl_vars['productPrice']->value) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>floatval($_smarty_tpl->tpl_vars['productPriceWithoutReduction']->value)),$_smarty_tpl);?>
...
<?php }?><?php }?></span><?php }?>
						...
						<span id="reduction_amount_display" <?php if (!$_smarty_tpl->tpl_vars['product']->value->specificPrice||$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']!='amount'||floatval($_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])==0) {?> style="display:none"<?php }?>><?php if ($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']=='amount'&&floatval($_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])!=0) {?>-<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>floatval($_smarty_tpl->tpl_vars['productPriceWithoutReduction']->value)-floatval($_smarty_tpl->tpl_vars['productPrice']->value)),$_smarty_tpl);?>
<?php }?></span>
...
" class="color_pick<?php if (($_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value)) {?> selected<?php }?><?php if (($_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['value']=='#ffffff')) {?> color_pick_white<?php }?>"<?php if (!$_smarty_tpl->tpl_vars['img_color_exists']->value&&isset($_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['value'])&&$_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['value']) {?> style="background:<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['value'], ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?>
					...
					<?php if (Module::isEnabled('an_staticblocks')&&(Module::getInstanceByName('an_staticblocks')->isEnabledBlock('advantage_productPage1')||Module::getInstanceByName('an_staticblocks')->isEnabledBlock('advantage_productPage2')||Module::getInstanceByName('an_staticblocks')->isEnabledBlock('advantage_productPage3'))) {?>
						<div class="advantage_productPage_wr clearfix">
							<?php if (Module::isEnabled('an_staticblocks')&&Module::getInstanceByName('an_staticblocks')->isEnabledBlock('advantage_productPage1')) {?>
								<div class="advantage_productPage">
									<?php echo Module::getInstanceByName('an_staticblocks')->getBlock('advantage_productPage1','advantage.tpl');?>

								</div>
							<?php }?>

							<?php if (Module::isEnabled('an_staticblocks')&&Module::getInstanceByName('an_staticblocks')->isEnabledBlock('advantage_productPage2')) {?>
								<div class="advantage_productPage">
									<?php echo Module::getInstanceByName('an_staticblocks')->getBlock('advantage_productPage2','advantage.tpl');?>

								</div>
							<?php }?>

							<?php if (Module::isEnabled('an_staticblocks')&&Module::getInstanceByName('an_staticblocks')->isEnabledBlock('advantage_productPage3')) {?>
								<div class="advantage_productPage">
									<?php echo Module::getInstanceByName('an_staticblocks')->getBlock('advantage_productPage3','advantage.tpl');?>
...
<?php $_smarty_tpl->tpl_vars['display_type'] = new Smarty_variable('simple_tabs', null, 0);?>
<div id="an_bootstraptabs" data-type="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['display_type']->value, ENT_QUOTES, 'UTF-8', true);?>
" class="panel">
<?php if ($_smarty_tpl->tpl_vars['display_type']->value=='accordion'||$_smarty_tpl->tpl_vars['display_type']->value=='two_cols_accordion') {?>
	<div class="bs-example"></div>
<?php } else { ?>
	<div class=" <?php if ($_smarty_tpl->tpl_vars['display_type']->value=='left_tabs'||$_smarty_tpl->tpl_vars['display_type']->value=='left_vertical_tabs') {?> tabgroup_left<?php }?><?php if ($_smarty_tpl->tpl_vars['display_type']->value=='right_tabs'||$_smarty_tpl->tpl_vars['display_type']->value=='right_vertical_tabs') {?> tabgroup_left<?php }?> indent">
		<?php if ($_smarty_tpl->tpl_vars['display_type']->value=='right_tabs'||$_smarty_tpl->tpl_vars['display_type']->value=='right_vertical_tabs') {?>
			<?php if ($_smarty_tpl->tpl_vars['display_type']->value!='simple_tabs') {?>
				<div class="col-xs-<?php if ($_smarty_tpl->tpl_vars['display_type']->value=='left_vertical_tabs'||$_smarty_tpl->tpl_vars['display_type']->value=='right_vertical_tabs') {?>11<?php } else { ?>8<?php }?>  col-lg-<?php if ($_smarty_tpl->tpl_vars['display_type']->value=='left_vertical_tabs'||$_smarty_tpl->tpl_vars['display_type']->value=='right_vertical_tabs') {?>11<?php } else { ?>10<?php }?>">
			<?php }?>
			<div class="tab-content"></div>
			<?php if ($_smarty_tpl->tpl_vars['display_type']->value!='simple_tabs') {?>
				</div><div class="col-xs-<?php if ($_smarty_tpl->tpl_vars['display_type']->value=='left_vertical_tabs'||$_smarty_tpl->tpl_vars['display_type']->value=='right_vertical_tabs') {?>1<?php } else { ?>4<?php }?> col-lg-<?php if ($_smarty_tpl->tpl_vars['display_type']->value=='left_vertical_tabs'||$_smarty_tpl->tpl_vars['display_type']->value=='right_vertical_tabs') {?>1<?php } else { ?>2<?php }?>">
			<?php }?>
			<ul class="nav nav-tabs<?php if ($_smarty_tpl->tpl_vars['display_type']->value=='left_tabs'||$_smarty_tpl->tpl_vars['display_type']->value=='left_vertical_tabs') {?> tabs-left<?php }?><?php if ($_smarty_tpl->tpl_vars['display_type']->value=='right_tabs'||$_smarty_tpl->tpl_vars['display_type']->value=='right_vertical_tabs') {?> tabs-right<?php }?><?php if ($_smarty_tpl->tpl_vars['display_type']->value=='left_vertical_tabs'||$_smarty_tpl->tpl_vars['display_type']->value=='right_vertical_tabs') {?> vertical-text<?php }?>"></ul>
			<?php if ($_smarty_tpl->tpl_vars['display_type']->value!='simple_tabs') {?></div><?php }?>
		<?php } else { ?>
			<?php if ($_smarty_tpl->tpl_vars['display_type']->value!='simple_tabs') {?>
				<div class="col-xs-<?php if ($_smarty_tpl->tpl_vars['display_type']->value=='left_vertical_tabs'||$_smarty_tpl->tpl_vars['display_type']->value=='right_vertical_tabs') {?>1<?php } else { ?>4<?php }?> col-lg-<?php if ($_smarty_tpl->tpl_vars['display_type']->value=='left_vertical_tabs'||$_smarty_tpl->tpl_vars['display_type']->value=='right_vertical_tabs') {?>1<?php } else { ?>2<?php }?>">
			<?php }?>
...
<?php if (isset($_smarty_tpl->tpl_vars['accessories']->value)&&$_smarty_tpl->tpl_vars['accessories']->value) {?>
	...
	<section class="accessories">
		<h3 class="page-accessories-heading"><?php echo smartyTranslate(array('s'=>'Related products'),$_smarty_tpl);?>
</h3>
		<div class=" accessories-block clearfix">
			<div class="block_content">
				<ul id="bxslider" class="accessories_slider clearfix">
...
?>
						...
						<?php if (($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity_all_versions']>0||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)&&$_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)) {?>
							...
							<li class="item ajax_block_product <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['first']) {?> first_item<?php } elseif ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['last']) {?> last_item<?php } else { ?> item<?php }?> product_accessories_description">
...
"/>
											...
											<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayProductPriceBlock",'id_accessory'=>$_smarty_tpl->tpl_vars['accessory']->value['id_accessory'],'type'=>"old_price"),$_smarty_tpl);?>

											<?php if ($_smarty_tpl->tpl_vars['accessory']->value['specific_prices']['reduction_type']=='percentage') {?>
												<span class="percent-reduction">-<?php echo $_smarty_tpl->tpl_vars['accessory']->value['specific_prices']['reduction']*100;?>
%</span>
											<?php }?>
											<?php if (isset($_smarty_tpl->tpl_vars['accessory']->value['new'])&&$_smarty_tpl->tpl_vars['accessory']->value['new']==1) {?>
												<a class="new-label" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
"><?php echo smartyTranslate(array('s'=>'New'),$_smarty_tpl);?>
</a>
											<?php }?>

											<a class=" addToWishlist wishlistProd_<?php echo intval($_smarty_tpl->tpl_vars['accessory']->value['id_accessory']);?>
" href="#" rel="<?php echo intval($_smarty_tpl->tpl_vars['accessory']->value['id_accessory']);?>
" title="<?php echo smartyTranslate(array('s'=>'Add to Wishlist'),$_smarty_tpl);?>
" onclick="WishlistCart('wishlist_block_list', 'add', '<?php echo intval($_smarty_tpl->tpl_vars['accessory']->value['id_accessory']);?>
', false, 1); return false;"></a>
									...
									<div class="right-block">
										<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessoryLink']->value, ENT_QUOTES, 'UTF-8', true);?>
" itemprop="name" class="product-name">
