<?php /* Smarty version Smarty-3.1.19, created on 2017-11-07 18:15:14
         compiled from "C:\xampp\htdocs\laquintapatita\themes\agnezit\modules\blockcart\blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:317305a0222629f6e34-32187675%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c9303bcf4e82a4733d00b9ee26190ff9a4ff680' => 
    array (
      0 => 'C:\\xampp\\htdocs\\laquintapatita\\themes\\agnezit\\modules\\blockcart\\blockcart.tpl',
      1 => 1507755985,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '317305a0222629f6e34-32187675',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a022263242571_56340456',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a022263242571_56340456')) {function content_5a022263242571_56340456($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\xampp\\htdocs\\laquintapatita\\tools\\smarty\\plugins\\modifier.replace.php';
...
<div class=" cart <?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> header_user_catalog<?php }?>">
<?php }?>
	<div class="shopping_cart">
		<span class="cart_close"></span>
		<span class="cart_head"><?php echo smartyTranslate(array('s'=>'Shopping cart','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
...
" class="need_hide" title="<?php echo smartyTranslate(array('s'=>'View my shopping cart','mod'=>'blockcart'),$_smarty_tpl);?>
" rel="nofollow">
...
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
"><?php echo htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value['name'],17,'...'), ENT_QUOTES, 'UTF-8', true);?>
</a>
											</div>
...
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['cart']->value->getOrderTotal(true,$_smarty_tpl->tpl_vars['cart_flag']->value)),$_smarty_tpl);?>
						...
						<p class="cart-buttons">
							<a id="button_order_cart" class="checkout_button" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
